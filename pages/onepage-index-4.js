...
const IndexSingle4 = () => {
  ...
  return (
    ...
    >
      ...
      <section className="service-section-four pt-125" id="onepage-service">
        <div className="container">
      ...
      {/*====== End Service Section ======*/}
      {/*====== Start About Section ======*/}
      <section className="about-section-two pt-100" id="onepage-about">
        <div className="container">
          <div className="row align-items-center">
      ...
      <section
        className="testimonial-section-variable-width pt-120"
